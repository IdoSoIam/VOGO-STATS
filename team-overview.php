...
require 'header.php'; ?>
	                ...
	                <div class="row">
	                                ...
	                                <div class="row">
	                                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-12">
	                                        <div class="text-center">
	                                            <img src="https://stadetoulousain-tennisclub.com/wp-content/uploads/2017/06/logo_stade_toulousain_tennis.png" alt="User Avatar" class="rounded-circle user-avatar-xxl">
	                                            </div>
	                                        </div>
	                                            ...
	                                            <div class="user-avatar-info">
	                                                <div class="m-b-20">
	                                                    <div class="user-avatar-name">
	                                                        <h2 class="mb-1">Stade Toulousain</h2>
	                                                    </div>
	                                                </div>
	                                                <!--  <div class="float-right"><a href="#" class="user-avatar-email text-secondary">www.henrybarbara.com</a></div> -->
	                                                <div class="user-avatar-address">
	                                                    <p class="border-bottom pb-3">
	                                                        <span class="d-xl-inline-block d-block mb-2"><i class="fa fa-map-marker-alt mr-2 text-primary "></i>Stade Ernest-Wallon; 114, rue des Troènes; BP 42354 31022 Toulouse Cedex 2</span>
	                                                        <span class="mb-2 ml-xl-4 d-xl-inline-block d-block">Client depuis : 23 Juillet, 2018  </span>
	                                                    </p>
	                                                    <div class="mt-3">
	                                                        <a href="#" class="badge badge-light mr-1">Sport</a> <a href="#" class="badge badge-light mr-1">Rugby</a> <a href="#" class="badge badge-light">Top 14</a>
	                                                    </div>
	                                                </div>
	                                            </div>
	                                        </div>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
	                                        <h5 class="text-muted">Spectateurs sur VOGO</h5>
	                                        <h2 class="mb-0"> 124 763</h2>
	                                    </div>
	                                    <div class="float-right icon-circle-medium  icon-box-lg  bg-primary-light mt-1">
	                                        <i class="fas fa-video fa-fw fa-sm text-primary"></i>
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body" style="max-height: 112px;">
                                        <h5 class="text-muted">Temps visionnage moyen sur VOGO</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">64 min.</h1>
                                        </div>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
	                                        <h5 class="text-muted">Profil type</h5>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <h5 class="card-header">Spectateurs par sexe</h5>
	                                <div class="card-body">
