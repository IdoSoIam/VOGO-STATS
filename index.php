                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Joueur le plus regardé</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">12000 vue</h1>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Action la plus regardé</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">120000 vue</h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span><i class="fa fa-fw fa-arrow-up"></i></span><span>5.86%</span>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Joueurs les plus vue (semaine)</h5>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Nbr de vue</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
